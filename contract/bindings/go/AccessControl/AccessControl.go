...
// GetRoleMemberIndex is a paid mutator transaction binding the contract method 0x4e0df3f6.
//
// Solidity: function getRoleMemberIndex(bytes32 role, address account) returns(uint256)
func (_AccessControl *AccessControlTransactor) GetRoleMemberIndex(opts *bind.TransactOpts, role [32]byte, account common.Address) (*types.Transaction, error) {
	return _AccessControl.contract.Transact(opts, "getRoleMemberIndex", role, account)
}

// GetRoleMemberIndex is a paid mutator transaction binding the contract method 0x4e0df3f6.
//
// Solidity: function getRoleMemberIndex(bytes32 role, address account) returns(uint256)
func (_AccessControl *AccessControlSession) GetRoleMemberIndex(role [32]byte, account common.Address) (*types.Transaction, error) {
	return _AccessControl.Contract.GetRoleMemberIndex(&_AccessControl.TransactOpts, role, account)
}

// GetRoleMemberIndex is a paid mutator transaction binding the contract method 0x4e0df3f6.
//
// Solidity: function getRoleMemberIndex(bytes32 role, address account) returns(uint256)
func (_AccessControl *AccessControlTransactorSession) GetRoleMemberIndex(role [32]byte, account common.Address) (*types.Transaction, error) {
	return _AccessControl.Contract.GetRoleMemberIndex(&_AccessControl.TransactOpts, role, account)
}
